...
<div class="form-group">
	<label for="marital_status">Marital status</label> <select
		...
		<option value="1" {{$client->marital_status == 1
			?'selected="selected"':''}}>Single</option>
		<option value="2" {{$client->marital_status == 2
			?'selected="selected"':''}}>Merried</option>
		<option value="3" {{$client->marital_status == 3
...
<div class="radio">
	<label> <input name="sex" value="m" type="radio" {{$client->sex ==
		'm'?'checked="checked"':''}} />Male
	</label>
</div>
<div class="radio">
	<label> <input name="sex" value="f" type="radio" {{$client->sex ==
...
<div class="form-group">
	<label for="physical_disability">Physical disability</label> <input
		...
		name="physical_disability" value="{{$client->physical_disability}}" />
</div>
<div class="checkbox">
	<label> <input id="defaulter" name="defaulter" type="checkbox"
		{{$client->defaulter?'checked="checked"':''}}/>Defaulter?
	</label>
</div>